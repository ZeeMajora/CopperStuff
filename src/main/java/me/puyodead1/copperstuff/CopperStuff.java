...
import me.puyodead1.copperstuff.common.registry.BlockRegistry;
...
public class CopperStuff {
    ...
    public static final NonNullLazy<Registrate> REGISTRATE = NonNullLazy.of(() -> Registrate.create(MOD_ID));
